...
int main(int argc, char **argv)
{
    if(argc != 7)
    {
        cerr << endl << "Usage: ./stereo_euroc_savemap path_to_vocabulary path_to_settings path_to_left_folder path_to_right_folder path_to_times_file path_to_map" << endl;
        return 1;
    }
